import VMLabel from "../component/VMLabel";
...
export class i18nLabel extends cc.Label {
    ...
    private setEndValue() {
        ...
        if (this.node.getComponent(VMLabel)) {
            // this.node.getComponent(VMLabel).enabled = true;
            this.node.getComponent(VMLabel).onValueInit();
        }
    }
