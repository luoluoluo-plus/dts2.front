...
import { StringFormatFunction } from '../core/StringFormat';
...
export default class VMLabel extends VMBase {
    ...
    private labelType: string = LABEL_TYPE.I18nLabel||LABEL_TYPE.CC_LABEL;
    ...
    onEnable() {
        super.onEnable();
        if (!this.node.getComponent(i18nLabel)) {
            this.onValueInit();
        }
    }
